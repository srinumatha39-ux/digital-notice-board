/* ==========================================================================
   ...
   Render Production Link: https://digital-notice-board-yggk.onrender.com
   Supabase Cloud Endpoint: https://pcwwukuxarlridmdfxlz.supabase.co
   Supabase Access Key: sbp_b211a70cc7ed789c11f03d33b9dacac4f2d627a1
   ========================================================================== */
...
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://pcwwukuxarlridmdfxlz.supabase.co';
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY || 'sbp_b211a70cc7ed789c11f03d33b9dacac4f2d627a1';
...
app.get('/', (req, res) => {
    res.json({
        ...
        renderUrl: 'https://digital-notice-board-yggk.onrender.com',
...
server.listen(PORT, () => {
    ...
    console.log(`Render Production Link: https://digital-notice-board-yggk.onrender.com`);
    console.log(`Supabase Endpoint:      ${SUPABASE_URL}`);
    console.log(`Supabase Key:           ${SUPABASE_ANON_KEY.substring(0, 12)}...`);
