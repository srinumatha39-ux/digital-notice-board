...
/* ================================================= */
/* PUSH NOTIFICATION SUBSCRIPTION (client-side)      */
/* Call subscribeToPush(collegeId) right after a      */
...
async function subscribeToPush(collegeId, rollNumber) {
    ...
    try {
        ...
        // Send the subscription to your backend, tied to the college
        ...
        console.log("Push subscription saved for college:", collegeId);
    } catch (err) {
        console.error("Push subscription failed:", err);
    }
}

// Example: call this inside your existing student login success handler
// subscribeToPush(collegeId, rollNumber);
