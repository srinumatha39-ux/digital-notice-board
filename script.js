...
// --------------------------------------------------------------------------
const SUPABASE_URL = 'https://pcwwukuxarlridmdfxlz.supabase.co';
const RENDER_PROD_URL = 'https://digital-notice-board-yggk.onrender.com/api';
...
async function fetchColleges() {
    const endpoints = [RENDER_PROD_URL, LOCAL_API_URL];
...
function updateConnectionStatus(isOnline) {
    ...
    [adminBadge, studentBadge].forEach(badge => {
        ...
        if (isOnline) {
            ...
            badge.querySelector('.status-text').textContent = 'Render & Supabase Online';
            badge.title = `Connected to Production Render (${API_BASE_URL}) and Supabase Cloud (${SUPABASE_URL})`;
        } else {
